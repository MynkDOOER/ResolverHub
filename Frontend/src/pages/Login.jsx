...
const Login = () => {
  ...
  return (
    <>
      <div
        className="flex min-h-screen items-center justify-center bg-slate-50 p-4 antialiased"
              ...
              <div className="pt-2 text-center">
                <p className="text-sm text-slate-500">
                  ...
                  <button
                    ...
                    className="font-semibold text-purple-600 transition hover:text-purple-800 hover:underline"
                  >
                    Signup
                  </button>
                </p>
